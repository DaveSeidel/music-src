...
-d --sample-accurate -W -o ophanim-chords.wav
; -+rtmidi=portmidi -Q1
</CsOptions>
...
instr Chord
    ...
    a1 = poscil3(aenv, icps1, 999)
    a2 = poscil3(aenv, icps2, 999)
    a3 = poscil3(aenv, icps3, 999)
    a4 = poscil3(aenv, icps4, 999)
    a5 = poscil3(aenv, icps5, 999)
    a6 = poscil3(aenv, icps6, 999)
    ...
    aenv2 = icps4 * 8 * aenv
    aout1 = butterlp(aout1, aenv2)
    aout2 = butterlp(aout2, aenv2)
